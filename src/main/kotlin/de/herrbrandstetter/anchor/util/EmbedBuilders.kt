...
fun buildAboutEmbed() = EmbedBuilder()
    ...
    .setDescription(
        """
            Your personal news anchor right inside Discord! Always be up-to-date about what's happening around the world, and stay informed about the topics you're interested in.
