...
fun buildGuideEmbed() = EmbedBuilder()
    ...
    .addField("`search` option",
        """
            ...
            To exclude certain keywords from the search, use the NOT operator: `Apple NOT iPhone`
    ...
    .addField("Language and country options",
        ...
        """.trimIndent(), false)
    .addField("Date options", "Dates you provide for `from` or `to` filter options must respect the following format: `YYYY-MM-DD` or `YYYY-MM-DD-hh:mm:ss`. Note that the time will always be determined relative to UTC. If no time is provided, 12 am is the default.", false)
    .setThumbnail("https://cdn.discordapp.com/avatars/1122537043856203776/12a8adf9c9ce4cda048fa558272cd015.png")
    .build()